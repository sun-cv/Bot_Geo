...
const commandsHome = new EmbedBuilder()
	...
	.addFields(
		{ name: '🔸 placeholder:', value: 'here is a placeholder that holds the place of a thing that should be in it\'s place, but wasn\'t found in the place it was meant to be placed.' },
